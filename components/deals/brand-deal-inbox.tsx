...
function DealRow({ deal }: { deal: BrandInboxDeal }) {
  return (
    <li>
      <Link
        href={`/deals/${deal.id}`}
        className="-mx-2 flex flex-wrap items-center justify-between gap-x-4 gap-y-1 rounded-md px-2 py-3 transition-all duration-300 ease-out hover:bg-muted/50 active:scale-[0.99] focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
      >

  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="absolute inset-y-0 right-0 grid w-9 place-items-center rounded-r-lg text-neutral-500 transition-colors duration-300 ease-out hover:text-neutral-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-900"
      >
        {visible ? (
